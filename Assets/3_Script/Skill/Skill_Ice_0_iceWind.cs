...
using DragonBones;
public class Skill_Ice_0_iceWind : Skill_Base
{
    [GUIColor(0f, 1f, 1, 1f)]
    // skill thunderStrike
    public GameObject iceWind;
    ...
    public override void CastSkill()
    {
        ...
        var newIceBolt = Instantiate(iceWind);
        var pos = transform.position;
        pos.x += 1;
        pos.y += -1;
        newIceBolt.transform.position = pos;
